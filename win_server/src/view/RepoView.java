...
public class RepoView extends JPanel {
    ...
    /**
     * Generated serial version ID for RepoView class
     */
    ...
    private void init() {
        ...
        addBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                //AddAbbrDialog addAbbr = new AddAbbrDialog(RepoView.this,"");
    ...
    private void setupRepoTable() {
        ...
        repoTable.setPreferredScrollableViewportSize(new java.awt.Dimension(340, 395));
