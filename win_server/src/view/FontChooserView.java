    ...
    public void init() {
        ...
        fontSizeChoice.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                sizeTextField.setText(fontSizeChoice.getSelectedValue().toString());
            }
        });

        fontNameChoice = new JList(GraphicsEnvironment.getLocalGraphicsEnvironment().getAvailableFontFamilyNames());
        ...
        textColorButton.add(BorderLayout.NORTH, new JLabel("Select", JLabel.CENTER));
        textColorButton.add(BorderLayout.SOUTH, new JLabel("Text Color", JLabel.CENTER));
        ...
        bgColorButton.add(BorderLayout.NORTH, new JLabel("Select", JLabel.CENTER));
        bgColorButton.add(BorderLayout.SOUTH, new JLabel("Background", JLabel.CENTER));
        ...
        textColorLabel.setBorder(BorderFactory.createTitledBorder("Color Preview"));
        ...
        okButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                mv.setTextFontTracker(new FontTracker(newFont, newForeColor, newBackColor));
            ...
            private Font getUpdatedFont() {
                ...
                String resultFontName = (String) fontNameChoice.getSelectedValue();
