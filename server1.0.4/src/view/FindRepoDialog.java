...
public class FindRepoDialog extends JDialog {
	...
	public FindRepoDialog(DeafBookView owner) {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				// 소스필드가 비어있을때
					...
					warning.setText("파일을 선택해주세요.");
                                        ...
                                        name = name.substring(0,name.lastIndexOf(".dat"));
                                        
                                                                            
                                        owner.SetLibraryName(name);
                                        owner.SetLibraryAddress(sourceField.getText());
					
					dispose();
					
//					if (owner.createRepo(titleField.getText(),
//							sourceField.getText()) != null) {
//						dispose();
//					} else {
...
//					}
	...
	private static class CustomFilter extends
