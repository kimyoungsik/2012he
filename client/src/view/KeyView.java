	...
	public void init()// 시작 부분인데
	{
		...
		confirmBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (first.equals("e1og") && second.equals("krr2") && third.equals("ywj0") && last.equals("sska")) {

					//true
					  String str = "deaf ver 1.0.3 client for JNU";
				        
				     FileWriter fw = null;
					try {
						fw = new FileWriter(System.getProperty("user.home") + File.separator + "Library/deafsoftwarec.txt");
						fw.write(str);
					    fw.flush();
					    fw.close();
					    authorization = true;
